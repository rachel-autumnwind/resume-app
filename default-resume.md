...
- **5 年** 前端经验：主导过大型 ToC 项目全链路开发，精通 Vue3 + TS，具备从 0 到 1 独立搭建项目、微前端架构（Qiankun）及自研 UI 组件库的工程化能力。

- **底层建设**： 独立负责企业级 前端 SDK 研发与 UI 组件库沉淀，擅长编写高复用、可扩展代码，具备深厚的技术方案设计能力。
...
### Pacdora 公司 | 前端工程师 | 2024.07 - 2026.02
